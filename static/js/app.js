...
function handleData(bankData){
      ...
      Object.keys(parsedBankDataDict).forEach(function(key) {
          parsedBankData.push({'date': key, 'amount': parsedBankDataDict[key]})
      });
      ...
      var xTimeScale = d3.scaleTime()
        .range([0, chartWidth])
        .domain(d3.extent(parsedBankData, data => data.date));
      ...
      var yLinearScale = d3.scaleLinear()
        .range([chartHeight, 0])
        .domain(d3.extent(parsedBankData, data=> data.amount));
      ...
      chartGroup.append("path")
        ...
        .attr("d", drawLine(parsedBankData))
        .classed("line", true);
